...
<c:url var="insertOrUpdateUrl" value="/quan-tri/the-loai/chinh-sua"/>
<c:url var="newsAPIUrl" value="/api/admin/category"/>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach var="item" items="${model.listResult}">
                    <tr>
                        ...
                        <td>${item.code}</td>
                        <td>
                            <c:url var="editCategoryUrl" value="${insertOrUpdateUrl}">
...
<script type="text/javascript">
    ...
    function deleteNews(data) {
        $.ajax({
            ...
            success: function (rs) {
                window.location.href = "/quan-tri/the-loai/danh-sach?page=1&limit=2&message=delete_category";
                console.log(rs);
            },
            error: function (err) {
                console.log(err);
